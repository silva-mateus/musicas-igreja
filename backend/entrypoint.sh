...
chmod 755 /app/data
chmod 755 /app/data/logs /app/data/uploads /app/data/organized
...
export DATABASE_PATH=${DATABASE_PATH:-/app/data/pdf_organizer.db}
export UPLOAD_FOLDER=${UPLOAD_FOLDER:-/app/data/uploads}
export ORGANIZED_FOLDER=${ORGANIZED_FOLDER:-/app/data/organized}
export LOG_FOLDER=${LOG_FOLDER:-/app/data/logs}
